...
from Classifier.BP_Classifier import BPNerualNetwork
...
def main():
    ...
    image_filenames = ['HER2_image_data-roi-16/{}.jpg'.format(idx) for idx in index.astype(int)]
    ...
    for train_index, test_index in skf.split(combined_features, label):
        ...
        net = BPNerualNetwork(input_size=combined_features.shape[1], hidden_size1 = 20, hidden_size2 = 12, output_size = 3)
